...
const ListBillProcesing = ({ navigation, route }) => {
  const isFocused = useIsFocused();

  useEffect(() => {
    FindAllBill(2).then( (res) => {
  ...
  return (
    <View style={styles.itemScroll}>
        <View style={{marginTop: 50, backgroundColor: '#e8e4e3', flexDirection: 'row', paddingHorizontal: 20 ,justifyContent:'space-between'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("ListBillWait")}>
...
export default ListBillProcesing;
